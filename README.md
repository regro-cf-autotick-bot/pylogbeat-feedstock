...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pylogbeat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14928&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pylogbeat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pylogbeat` can be installed with:

```
conda install pylogbeat
```

It is possible to list all of the versions of `pylogbeat` available on your platform with:
